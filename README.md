...
The **Server OF_APP** draws your scene using the *linked/received* parameters from the **Clien OF_APP**.  
...
Below addons are bundled. Already included in `OF_ADDON/libs`.  
Do not requires to manually include into `Project Generator`.  
