...
```.cpp
	...
	{
		ofLogNotice() << "DONE LOAD PRESET. SOME GROUP HAVE CURRENTLY LOADED/CHANGED TO ANOTHER PRESET INDEX";
	}
	...
	void ofApp::Changed_PresetsManagerSelectors(ofAbstractParameter &e)
	{
		...
		ofLogNotice() << "THE SELECTOR FOR THER GROUP WITH NAME " << name << " CHANGED TO PRESET INDEX: " << e;
		if (name == params.getName()) 
		{
			// the selector index of this group changed,
			// then we know that some/all ofParameters of this ofParameterGroup changed,
